...
- [chapter1-landing.html](chapter1-landing.html) — interactive, gamified chapter landing page with quizzes, timelines, and achievements. Self-contained, no build step required.
- [index.html](index.html) — single-page, self-contained HVE maturity assessment tool (no build step required). Open it locally in any modern browser, or host it via GitHub Pages.

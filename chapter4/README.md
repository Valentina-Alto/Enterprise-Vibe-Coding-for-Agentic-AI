...
Companion assets for **Chapter 4: Reshaping the SDLC** from *Agentic Development in Practice*.
...
➡️ **[Launch the Chapter 4 Interactive Experience](https://valentinaalto.github.io/agentic-development-in-practice/code-and-assets/chapter4/chapter4-landing.html)**

> If the link above is not yet live, enable GitHub Pages on this repository (Settings → Pages → deploy from the `main` branch, root) and the page will be served from `code-and-assets/chapter4/`.
